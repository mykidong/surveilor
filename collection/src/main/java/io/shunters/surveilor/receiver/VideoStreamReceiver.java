...
public class VideoStreamReceiver extends Receiver<VideoStream> {
    ...
    public void onStart() {
        ...
        {
            VideoStreamReader reader = new VideoStreamReader(this, location, this.configuration.getStoreBatchSize(), this.configuration.getSamplingInterval(), this.configuration.getImageType());
